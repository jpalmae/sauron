import { Activity, Bell, Camera, Car, ChartColumn, LogOut, Map, ScanLine, ScrollText, Search, Settings, Users, Video, ChevronDown } from "lucide-react";
      ...
      <aside className="flex w-56 shrink-0 flex-col border-r border-line bg-panel">
        ...
        <nav className="mt-2 flex flex-col gap-1 px-2 overflow-y-auto">
          ...
          <Section label="Matrículas" icon={ScanLine} color="text-info" defaultOpen>
            ...
            <NavItem to="/alpr/config" label="Config API" icon={Settings} />
          </Section>
