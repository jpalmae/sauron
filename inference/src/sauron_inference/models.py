...
class ModelInfo:
    ...
    size_mb: int
    imgsz: int = 640  # square input resolution the model was exported with
...
CATALOG: dict[str, ModelInfo] = {
    ...
    "yolov8s-1280": ModelInfo("yolov8s-1280", "yolov8", "yolov8s_1280.onnx", "yolov8s_1280_fp16.engine", "S/M", 45, imgsz=1280),
    "yolov8m-1280": ModelInfo("yolov8m-1280", "yolov8", "yolov8m_1280.onnx", "yolov8m_1280_fp16.engine", "M/L", 104, imgsz=1280),
...
def model_imgsz(name: str) -> int:
    """Square input resolution the model was exported with."""
    return CATALOG[validate_model(name)].imgsz
